...
const mockedAvailableColumns = getTemplateColumns().splice(0, 50);
...
class DualListSelectorDoc extends Component {
  ...
  render() {
    return (
      <Page>
        <h2 className="catalog-h2">DualListSelector</h2>

        <p className="catalog-p">Use this component to build a dual list selection area. It consists of a wrapper component.</p>
