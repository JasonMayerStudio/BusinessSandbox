...
import './OldReportDetailDrawer.scss';

class OldReportDetailDrawer extends Component {
  constructor(props) {
    super(props);
  ...
  closeDrawer(event) {
    ...
    this.props.history.push(`/old-reports/${this.props.reportId}`);
  }
    ...
    return (
      <section className="drawer-content">
        <div className="drawer-heading">
          ...
          >
            Return to {removeTheLetterE || this.props.report.name} reports
          </Button>
          <Badge
            badgeType="reports"
          >
...
OldReportDetailDrawer.propTypes = {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(OldReportDetailDrawer));
