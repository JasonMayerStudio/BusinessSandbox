 ...
 */
describe('ReportBuilder container', function () {
  describe('smoke test', function () {
    ...
    beforeEach(function () {
      ...
      wrapper = mount(<ReportBuilder {...props} />);
    });

    it.skip('should display a ReportBuilder container', function () {
  ...
  describe('props tests', function () {
    ...
    it.skip('should display a dropdown to choose a template', function () {
      ...
      const templateList = templateDropdown.prop('dataList');
