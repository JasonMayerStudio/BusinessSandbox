  ...
  render() {
    return (
      <Page>
        ...
        <p>
          Use this component to create a dropdown list that functions like an
          HTML select element, but with custom style.
        </p>
        ...
        <p>
          ...
          {this.state.selectedItem && <em>{this.state.selectedItem.value}</em>}
        </p>

        <ReactSpecimen span={6}>
          <div className="field-group-vertical">
            <TextField htmlFor={name} labelContent="Select Role">
              <SelectInput
                dataList={roleList}
        ...
        <p>
          Your last selection was:{' '}
          {this.state.selectedRole && <em>{this.state.selectedRole.value}</em>}
        </p>
        ...
        <ul>
          <li>
            <strong>dataList</strong>: an array of objects with a value property
            and a text property
          </li>
          <li>
            <strong>handleSelection</strong>: a function that gets called when
            an item is selected. It gets the <em>value</em> and the{' '}
            <em>event</em>.
          </li>
          <li>
            <strong>wrapperClass</strong>: a class that determines what style of
            dropdown this menu is.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>selectedItem</strong>: the currently selected item (if any)
          </li>
          <li>
            <strong>promptText</strong>: the value to display if no item is
            selected (default is <em>Choose one</em>
          </li>
          <li>
          ...
          <li>
            <strong>isDisabled</strong>: if true, disabled the menu from being
            activated, and removed it from the tab order
          </li>
        </ul>
      </Page>
    );
