...
class LocationDetailDrawer extends Component {
  constructor(props) {
    super(props);
  ...
  closeDrawer(event) {
    ...
    this.props.history.push('/locations/management');
  }
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(LocationDetailDrawer));
