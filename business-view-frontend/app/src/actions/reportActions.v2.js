  ...
  return function dispatchGetOneReport(dispatch) {
    ...
    return apiGetOneReport(reportId)
      .then(({ data, headers }) => {
        ...
        const newReportId = data.reportId || data.id;
        const parsedReport = {
...
export function deleteReport(reportId) {
  return function dispatchDeleteReport() {
...
export function fetchReportPreview(report) {
  return function dispatchFetchReportPreview() {
...
export function updateVisibleReportColumns(reportId, columns) {
  return function dispatchFetchReportPreview() {
    return apiUpdateVisibleReportColumns(reportId, columns)
      .then(({ data }) => {
        return data;
      })
      .catch((error) => {
